<template>
  <div class="CustomLog">
    <sticky class-name="sub-navbar">
      <div class="filter-container">客户操作记录
      </div>
    </sticky>
    <el-table
      ...
      <el-table-column label="跟进次数" align="left">
        <template slot-scope="scope">
          <p><span>{{ scope.row.operDesc }}</span></p>
        </template>
      </el-table-column>
...
import { GetCustomLog } from '@/api/client/client-api'
...
export default {
  ...
  methods: {
    getList(id) {
      ...
      this.listQuery.custClueId = id
      GetCustomLog(this.listQuery).then(response => {
