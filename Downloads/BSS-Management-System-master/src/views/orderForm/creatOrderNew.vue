          ...
          <el-card>
            ...
            <div class="product">
                    ...
                    <el-row :gutter="24">
                      <el-col :span="8">
                        <el-form-item label-width="150px" label="订单归属" prop="busiType" class="postInfo-container-item">
                          <el-select v-model="postForm.busiType" placeholder="请选择订单归属">
              ...
              <el-collapse v-if="postForm.driverId" v-model="activeNames">
                    ...
                    <el-row :gutter="24">
                      <el-col :span="8">
                        <el-form-item label-width="110px" label="姓名" prop="driverName" class="postInfo-container-item inlineBlock">
                          <el-input v-model="postForm.driverName" disabled="disabled" placeholder="请输入姓名" />
                        </el-form-item>
                      </el-col>
                      <el-col :span="8">
                        <el-form-item label-width="110px" label="联系电话" prop="driverPhone" class="postInfo-container-item inlineBlock">
                          <el-input v-model="postForm.driverPhone" disabled="disabled" type="number" min="0" placeholder="请输入联系电话" />
                        </el-form-item>
                      </el-col>
                      <el-col :span="8">
                ...
                <el-collapse-item title="银行及第三方认证信息（请预留司机银行卡信息，并在上岗前补充完整，否则将影响司机运费结算）" name="2">
                  <el-card>
                    <el-row :gutter="24">
                      <el-col :span="8">
                        ...
                        <el-row>
                          ...
                          <el-col :span="12">
                            <div class="grid-content bg-purple-light">
                              ...
                              <el-form-item label-width="150px" label="线路管理费" prop="lineManagementFee" class="postInfo-container-item inlineBlock">
                                <el-select v-model="productForm.lineManagementFee" placeholder="请选择线路管理费" @change="changelineManagementFee">
                                  <el-option
                              ...
                              <el-form-item label-width="150px" label="交款流水号后四位" prop="last4Nums" class="postInfo-container-item inlineBlock">
          ...
          <el-timeline-item v-if="postForm.driverId && productForm.cooperationModel === '购车'" timestamp="产品信息" placement="top">
            <el-card>
              <el-row :gutter="24">
                ...
                <el-col v-if="postForm.product" :span="16">
                  <el-form-item label="">
              ...
              <el-row :gutter="24">
                ...
                <el-col :span="8">
                  <el-form-item label-width="110px" label="租赁方式" prop="rentalMethod" class="postInfo-container-item inlineBlock">
                    <el-select v-model="productForm.rentalMethod" placeholder="请选择租赁方式" @change="rentalMethodChange">
...
import { GetDriver, GetDriverDetail, GetProduct, getProductDetail, postSigning, GetFinancialList, GetFinancialDetail, GetFinancialProvidersStaging, carRentalModelSelection, rentalCompaniesSelection, withCarModelSelection } from '@/api/order/order-api'
  ...
  watch: {
    ...
    'productForm.managementFeeFirst'(val) {
      ...
      if (Number(val) > Number(this.lineManagementFeeMax)) {
        if (this.lineManagementFeeList.length) {
    ...
    'productForm.lineManagementFee'(val) {
      // this.calcLineManagementFee()
      this.calcOrder()
      this.changelineManagementFee(val)
      // this.calcTotal()
    },
  ...
  methods: {
    ...
    calcTotal() {
      if (this.productForm.cooperationModel === '购车') {
        ...
        this.productForm.totalPayment = Number(this.productForm.totalPayment).toFixed(2)
      }
    },
    // 订金总额
    calcOrder() {
      ...
      if (this.productForm.cooperationModel !== '购车') {
        this.lineManagementFeeList.forEach((item) => {
          if (item.codeVal === this.productForm.lineManagementFee) {
            this.productForm.totalOrder = Number(item.code).toFixed(2)
          }
        })
      }
    },
    rentalMethodChange() {
      this.productForm.leasingCompany = ''
    },
    ...
    getDetail(orderId) {
      ...
      GetDriver({
        ...
        if (res.data.success) {
          ...
          let obj2 = Object.assign(detail.productInfoForGeneraNewOrder, detail.productInformationRequiredForCarRental, detail.incomeAndExpenditureInformation, { productIdForOwnCar: detail.productIdForOwnCar }, { cooperationModel: detail.cooperationModel }, { busiType: String(detail.busiType) });
          ...
          if (!obj2.stagingParam) {
            obj2.stagingParam = ''
          }
          obj1.busiType = String(obj2.busiType);
    ...
    submitForm(formName, formName2, type) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          if (this.productForm.cooperationModel) {
