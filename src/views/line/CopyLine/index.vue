<template>
  <div class="CopyLineContainer">
    <van-sticky :offset-top="0">
      <van-nav-bar :title="title" left-text="返回" left-arrow @click-left="onClickLeft" />
    </van-sticky>
    <StepOne v-show="step === 1" type="copy" :form="stepOneForm" @stepTwo="step =2" />
    <StepTwo v-show="step === 2" type="copy" :max-date="stepOneForm.waitDirveValidity ? new Date(stepOneForm.waitDirveValidity) : new Date(2125, 12, 31)" :form="stepTwoForm" @stepThree="step=3" @step-one="step=1" />
