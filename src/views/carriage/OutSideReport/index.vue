  ...
  <div class="lineListContainer">
    ...
    <div class="cont_ent">
      ...
      <van-form :show-error="false" @submit="onSubmit">
        ...
        <div class="Bulk">
          <van-button v-preventreclick v-permission="['/v2/waybill/noCarBatchBySale']" native-type="button" @click="cancel">
            全部未出车
          </van-button>
          <van-button v-preventreclick v-permission="['/v2/waybill/reportMoneyBatchBySale']" native-type="submit">
            全部上报
          </van-button>
        </div>
      </van-form>
